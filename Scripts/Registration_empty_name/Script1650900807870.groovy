...
Mobile.setText(findTestObject('mobile/Door_registration/android.widget.EditText0'), '', 0)
...
Mobile.verifyElementExist(findTestObject('mobile/Door_registration/empty_name_alert'), 0)
