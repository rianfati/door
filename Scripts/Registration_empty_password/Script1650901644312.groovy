...
Mobile.setText(findTestObject('mobile/Door_registration/android.widget.EditText0 (2)'), '', 0)
...
Mobile.verifyElementExist(findTestObject('mobile/Door_registration/empty_password_alert'), 0)
