...
Mobile.setText(findTestObject('mobile/Door_registration/android.widget.EditText0'), 'admin2', 0)

Mobile.setText(findTestObject('mobile/Door_registration/android.widget.EditText0 (1)'), 'admin2@mail.com', 0)

Mobile.setText(findTestObject('mobile/Door_registration/android.widget.EditText0 (2)'), 'password123', 0)

Mobile.setText(findTestObject('mobile/Door_registration/android.widget.EditText0 (3)'), 'password1234', 0)

Mobile.tap(findTestObject('mobile/Door_registration/android.widget.Button0 - REGISTER'), 0)

Mobile.verifyElementExist(findTestObject('mobile/Door_registration/password_not_matches_alert'), 0)
